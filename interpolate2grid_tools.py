...
#        csv_timestamp='yyyy-mm-ddThh24:mi[GMT/UT]'
#        format='classic'

    return nc_data, nc_lat, nc_lon, csv_lon, csv_lat

def test_spatial_plot( data, lon, lat, locs, vals ):
    """
...
def extract_nearest_point_from_arr( data, lon, lat, locs, debug=False ):
    """
